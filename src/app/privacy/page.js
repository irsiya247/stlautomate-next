      ...
      <div className="max-w-3xl mx-auto px-6 pt-36 pb-24">
        ...
        <div className="space-y-10 text-slate-300 leading-relaxed">
          ...
          <section>
            ...
            <p>STL Automate LLC ("we", "us", "our") respects your privacy. This policy explains what information we collect, how we use it, and your rights regarding that information.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-slate-400 ml-2">
              ...
              <li>Messages or descriptions of your business needs</li>
              <li>Payment and billing information when you become a client</li>
            </ul>
            <p className="mt-3">We also collect standard website analytics data such as pages visited, browser type, and referring URLs through privacy-respecting analytics tools.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">We do not sell your personal information. We do not use your information for advertising purposes.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white mb-3">4. Information Sharing</h2>
            <p>We share your information only with third-party service providers who help us operate our business (such as email delivery and SMS platforms), and only to the extent necessary to provide those services. All third-party providers are required to keep your information confidential.</p>
          </section>
