      ...
      <div className="relative z-10 pt-36 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-invert max-w-none mb-16 space-y-6 text-slate-300 text-lg leading-relaxed">
            <p>STL Automate started with a job search.</p>
            <p>Our founder Matthew spent years in cybersecurity, a field that runs on precision, systems thinking, and knowing exactly where the vulnerabilities are. When he found himself in a job search, he noticed something: the process was almost entirely manual. Researching companies, tailoring applications, following up, tracking responses. Hours of repetitive work for every single opportunity.</p>
            <p>So he automated it. Not to cut corners. To free up time for the parts that actually required him. The personalized conversations. The relationship-building. The judgment calls that no spreadsheet could make.</p>
            <p>That experience turned into a question: how many small business owners are doing the same thing every day? Answering the same emails. Following up with the same leads. Playing phone tag with customers who just want a quick answer.</p>
            <p>A lot of them, it turns out.</p>
            <p>STL Automate exists to give small businesses the same leverage that large companies have, without the large company budget or the IT department to manage it. We build the systems, we run the setup, and we stay on as your partner as your business grows.</p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-5 text-slate-300 text-lg leading-relaxed">
              ...
              <p>When your phone gets answered automatically, your customer doesn&apos;t go to voicemail, and you don&apos;t spend your evening returning calls. When a lead gets followed up with automatically, you don&apos;t have to remember to do it. Neither does anyone else on your team.</p>
              <p>The result is that when you <em>do</em> talk to a customer, it&apos;s because the moment actually calls for a human. Not because the system missed them.</p>
              <p>We&apos;re a small team. We don&apos;t take on more clients than we can give real attention to. Every system we build gets tested, every client gets a direct line to the person who built it, and every question gets a real answer, not a ticket number.</p>
              <p>That&apos;s the part that doesn&apos;t get automated.</p>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-5 text-slate-300 text-lg leading-relaxed">
              ...
              <p>We work with businesses in St. Louis and beyond, but local clients get something extra: a face-to-face conversation if you want one, and a partner who understands what it means to run a small business in this city.</p>
            </div>
          </div>
